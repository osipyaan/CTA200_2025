...
Figure \ref{fig:lorenz_phase_yz} presents projections of the full three-dimensional phase space trajectory onto the $YZ$ and $XY$ planes respectively. The motion is perfectly deterministic, yet appears random and is highly sensitive to initial conditions.
...
\caption{Plot 1 shows the projection of the Lorenz attractor onto the $YZ$ plane. The two lobes of the strange attractor are clearly visible, showing the complex structure visited by the trajectory. Plot 2 shows the projection of the Lorenz attractor onto the $XY$ plane. The characteristic butterfly-like shape emerges from this perspective, illustrating why this structure is sometimes called the ``butterfly attractor.'' Numbers mark iterations at 100-step intervals.}
